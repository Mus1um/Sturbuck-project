        ...
        <div className="banner">
          ...
          <div className="right">
            ...
            >
              <SwiperSlide>
                <div className="text">
                  <h1>Coffee, Meet More Rewards</h1>
                  <p>
      ...
      <section>
        <div className="page-center">
          <div className="left-cards">
            <h1>
              Browse All Topics <HiArrowSmallRight />{" "}
            </h1>
            <div className="cards">
              <div className="card">
                <ul>
                ...
                <div className="svg-content">
                  <svg
                    ng-switch-when="redeemRewards"
                    aria-hidden="true"
                    class="sbuxIcon ng-scope"
                    focusable="false"
                  ...
                  <p className="svg-text">Starbucks Rewards</p>
                </div>
              </div>
              <div className="card">
                <ul>
                ...
                <div className="svg-content">
                  ...
                  <p className="svg-text">Starbucks Card</p>
                </div>
              </div>
              <div className="card">
                <ul>
              ...
              <div className="card">
                ...
                <div className="svg-content">
                  ...
                  <p className="svg-text">In Our Stores</p>
                </div>
              </div>
              <div className="card">
                <ul>
                ...
                <div className="svg-content">
                  ...
                  <p className="svg-text">Company Info</p>
                </div>
              </div>
              <div className="card">
                <ul>
                ...
                <div className="svg-content">
                  ...
                  <p className="svg-text">Coffee at Home</p>
                </div>
              </div>
            </div>
          </div>
